...
def _migrate_sqlite_columns() -> None:
    ...
    wanted = {
        "users": {
            ...
            "notify_email_to": "VARCHAR(255) DEFAULT ''",
            "outbound_proxy_enabled": "BOOLEAN DEFAULT 0",
            "outbound_proxy_type": "VARCHAR(16) DEFAULT 'socks5'",
            "outbound_proxy_host": "VARCHAR(255) DEFAULT '127.0.0.1'",
            "outbound_proxy_port": "INTEGER DEFAULT 10808",
            "outbound_proxy_user": "VARCHAR(120) DEFAULT ''",
            "outbound_proxy_password": "VARCHAR(255) DEFAULT ''",
            "outbound_proxy_vless": "TEXT DEFAULT ''",
        },
        "projects": {
